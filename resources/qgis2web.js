...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 20, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
            //extent: [72.850610, 19.115189, 72.855836, 19.122562],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([273389.455414, 2114976.662840, 275253.217369, 2115871.146464], map.getSize());
